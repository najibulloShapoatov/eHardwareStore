...
@section('description', 'Поиск товара')
            ...
            <div class="page-header__breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Поиск товара</li>
                    </ol>
                </nav>
            </div>
            <div class="page-header__title">
                <br>
                <p class="searchTxt">Вы искали: "<strong>{{ $searchText }}</strong>"</p>
            </div>
        </div>
    </div>
                        ...
                        @foreach($data as $item)
                            <tr class="wishlist__row wishlist_{{ $item->id }}">
                                ...
                                <td class="wishlist__column wishlist__column--product">
                                    <a href="/catalog/product/{{ $item->articul }}" class="wishlist__product-name">
                                        {!! str_ireplace($searchText,"<span class='sblTxt'>" . $searchText . "</span>",$item->title)  !!}
                                    </a>
                                    ...
                                    <small>{!! str_ireplace($searchText,"<span class='sblTxt'>" . $searchText . "</span>",$item->description)  !!}</small>
                                </td>
