...
@section('title', 'Советы от АЗИМИСТРОЙ')
@section('description', 'Советы от АЗИМИСТРОЙ')
            ...
            <div class="page-header__breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Советы от АЗИМИСТРОЙ</li>
                    </ol>
                </nav>
            </div>
            <div class="page-header__title">
                <h1>Советы от АЗИМИСТРОЙ</h1>
            </div>
        </div>
    </div>
